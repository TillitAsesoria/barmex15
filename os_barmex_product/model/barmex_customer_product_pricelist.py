...
class CustomerPriceList(models.Model):
    ...
    _sql_constraints = [
        ('unique_customer_pricelist', 'unique(partner_id,pricelist_id)',
    ...
    partner_id = fields.Many2one(
        'res.partner',
        string='Customer')
    customer_product_pricelist_ids = fields.One2many(
        'res.partner',
        'id',
    ...
    pricelist_id = fields.Many2one(
        ...
        readonly=True,
        index=True)
    pricelist_usd_id = fields.Many2one(
        'product.pricelist',
        string='Pricelist USD',
        readonly=True,
        index=True)
    pricelist_extra_id = fields.Many2one(
        'product.pricelist',

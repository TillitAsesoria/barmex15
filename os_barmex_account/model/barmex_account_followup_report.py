...
class AccountFollowupReport(models.AbstractModel):
    ...
    def _get_lines(self, options, line_id=None):
        ...
        line_num = 0
        for l in partner.unreconciled_aml_ids.filtered(
                lambda l: l.company_id == self.env.company):
        ...
        for currency, aml_recs in res.items():
            ...
            for aml in aml_recs:
                ...
                barmex_date = aml.payment_id.payment_date_lco
                ...
                columns = [
                    ...
                    format_date(self.env, barmex_date, lang_code=lang_code),
                    date_due,
                    invoice_origin,
                    move_line_name,

...
class PurchaseOrderLine(models.Model):
    ...
    transfer = fields.Boolean(
        'Transfer',
        related='order_id.transfer', store=True, readonly=True)
    ...
    @api.depends('product_qty', 'price_unit', 'taxes_id',
                 'discount_amount_lco', 'discount_percentage_lco')
    def _compute_amount(self):
        for line in self:
            ...
            if line.discount_amount_lco > 0:
                ...
                discount = (
                                       line.price_subtotal * line.discount_percentage_lco) / 100
    ...
    def _prepare_stock_moves(self, picking):
        ...
        template = {
            ...
            'route_ids': self.order_id.picking_type_id.warehouse_id and [
                (6, 0, [x.id for x in
                        self.order_id.picking_type_id.warehouse_id.route_ids])] or [],
